...
import com.ecoapi.techstore.product.application.service.*;
import com.ecoapi.techstore.product.infrastructure.adapter.TransactionalUseCaseWrapper;
import com.ecoapi.techstore.product.infrastructure.adapter.output.events.ProductEventPublisherAdapter;
import com.ecoapi.techstore.product.infrastructure.adapter.output.persistence.BrandRepositoryAdapter;
import com.ecoapi.techstore.product.infrastructure.adapter.output.persistence.mapper.ProductPersistenceMapper;
import com.ecoapi.techstore.product.infrastructure.adapter.output.persistence.CategoryRepositoryAdapter;
import com.ecoapi.techstore.product.infrastructure.adapter.output.persistence.ProductRepositoryAdapter;
...
public class ProductConfiguration {
    ...
    @Bean
    public ActivateProductUseCase activateProductUseCase(ProductRepositoryPort productRepository) {
        ActivateProductUseCase service = new ActivateProductService(productRepository);
        return new TransactionalUseCaseWrapper.TransactionalActivateProductUseCase(service);
    }

    @Bean
    public DeactivateProductUseCase deactivateProductUseCase(ProductRepositoryPort productRepository) {
        DeactivateProductUseCase service = new DeactivateProductService(productRepository);
        return new TransactionalUseCaseWrapper.TransactionalDeactivateProductUseCase(service);
    }
    ...
    @Bean
    public AdminSearchProductsUseCase adminSearchProductsUseCase(ProductRepositoryPort productRepository) {
        AdminSearchProductsUseCase service = new AdminSearchProductsService(productRepository);
        return new TransactionalUseCaseWrapper.TransactionalAdminSearchProductsUseCase(service);
    }
